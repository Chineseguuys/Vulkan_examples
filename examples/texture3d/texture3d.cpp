...
#ifdef DEBUG
        spdlog::info("[{}:{}] maxImageDimension3D: {}", __FILE__, __LINE__, maxImageDimension3D);
#endif // DEBUG
...
#ifdef DEBUG
            overlay->text("show depth: %f - %d",
                uniformData.depth, static_cast<uint32_t>(uniformData.depth * texture.depth));
#endif // DEBUG
